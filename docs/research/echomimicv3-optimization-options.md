...
| **NF4 量化 (Modal T4)** ✅                    | **5.0 min**  | ~1.7 小时     | Modal 186GB RAM，NF4 + model_cpu_offload，13.8s/step vs baseline 24.2s/step，43% 加速。脚本：`scripts/short-video/experiments/modal-echomimicv3-nf4.py`（已于 2026-09-20 删除，参数见 `docs/research/digital-human-test-progress.md`） |
