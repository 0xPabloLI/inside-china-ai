...
>
> **输入类型图例**：
> - 📸 **照片+音频** — 单张照片 + 音频 → 说话视频（非克隆，one-shot 生成）
> - 🎥 **视频+音频** — 已有视频 + 音频 → 唇同步替换（非克隆，编辑现有视频）
> - 🎥 **视频+视频** — 驱动视频 → 表情/动作迁移（非音频驱动）
> - 🎓 **视频训练→模型** — 从用户视频训练个性化模型（克隆，训练后可任意驱动）
> - 📝 **文本→视频** — 文本直接生成说话视频（无需照片/视频）
> - 📸+🎓 **混合** — 支持多种输入模式

#### T0 — 顶会 SOTA（扩散/DiT，2024-2026）

| 排名 | 模型 | 输入类型 | 技术路线 | 会议 | 时间 | NVIDIA 必需 | 音频驱动 | 商用 | VRAM | 质量 | GitHub Stars |
|------|------|---------|---------|------|------|-----------|---------|------|------|------|-------------|
| 1 | **EMO** | 📸 照片+音频 | Audio2Video 扩散 | ECCV 2024 | 2024.02 | ✅ | ✅ | ❓ | 未公开 | ⭐⭐⭐⭐⭐ | 7601 |
| 2 | **Sonic** | 📸 照片+音频 | SVD 扩散 | **CVPR 2025** | 2024.12 | ✅（MPS ✅） | ✅ | ❌ 非商用 | 12GB | ⭐⭐⭐⭐⭐ | — |
| 3 | **Hallo3** | 📸 照片+音频 | **DiT** (CogVideo) | **CVPR 2025** | 2024.12 | ✅ H100 | ✅ | ✅ MIT | H100 | ⭐⭐⭐⭐⭐ | 8658 |
| 4 | **PersonaLive** | 📸 照片+音频 | 实时流式扩散 | **CVPR 2026** | 2025.12 | ✅（MPS ⚠️） | ✅ | ❌ 非商用 | 12GB | ⭐⭐⭐⭐⭐ | 3489 |
| 5 | **DICE-Talk** | 📸 照片+音频 | 扩散+情感解耦 | **ACM MM 2025** | 2025.04 | ✅ | ✅+情感 | ❌ 非商用 | 20GB+ | ⭐⭐⭐⭐⭐ | — |
| 6 | **LatentSync 1.6** | 📸 照片+音频 | 扩散+SyncNet | — | 2025.06 | ✅（MPS ⚠️） | ✅ | ✅ OpenRAIL++ | 18GB | ⭐⭐⭐⭐⭐ | — |
| 7 | **LatentSync 1.5** | 📸 照片+音频 | 扩散+SyncNet | — | 2024.12 | ✅（MPS ⚠️） | ✅ | ✅ OpenRAIL++ | **8GB** | ⭐⭐⭐⭐ | — |
| 8 | **Hallo2** | 📸 照片+音频 | 分层扩散 | — | 2024.10 | ✅ | ✅ | ✅ MIT | 20GB+ | ⭐⭐⭐⭐ | 8658 |
| 9 | **Hallo4** | 📸 照片+音频 | 扩散 | — | 2025.05 | ✅ | ✅ | ✅ MIT | 未标注 | ⭐⭐⭐⭐ | — |
| 10 | **OmniTalker** | 📝 文本+上下文 | 端到端扩散 | **NeurIPS 2025** | 2025 | ✅ | ✅ 文本+上下文 | ❓ | 未标注 | ⭐⭐⭐⭐⭐ | 425 |
| 11 | **InsTaG** | 🎓 视频训练→3D | 3D GS | **CVPR 2025** | 2025 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐⭐⭐ | 175 |
| 12 | **ACTalker** | 📸 照片+音频 | 端到端视频扩散 | **ICCV 2025** | 2025 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐⭐ | 463 |

#### T1 — 扩散方案（未达顶会但技术先进）

| 排名 | 模型 | 输入类型 | 技术路线 | 会议 | 时间 | NVIDIA 必需 | 音频驱动 | 商用 | VRAM | 质量 | GitHub Stars |
|------|------|---------|---------|------|------|-----------|---------|------|------|------|-------------|
| 10 | **V-Express** | 📸 照片+音频 | 渐进式扩散 | — | 2024.06 | ✅（MPS ⚠️） | ✅ | ❓ | ~12GB | ⭐⭐⭐⭐ | 2357 |
| 11 | **JoyVASA** | 📸 照片+音频 | 扩散+解耦表示 | — | 2024.11 | ✅ | ✅+中文 | ❓ | A100 | ⭐⭐⭐⭐ | 876 |
| 12 | **EchoMimic V2** | 📸 照片+音频 | 扩散+关键点 | — | 2024.07 | ✅ | ✅+关键点 | ✅ Apache | ~16GB | ⭐⭐⭐⭐ | 4279 |
| 13 | **AniPortrait** | 📸 照片+音频 | 关键点→扩散 | — | 2024.03 | ✅ | ✅ | ❓ | ~12GB | ⭐⭐⭐⭐ | 5019 |
| 14 | **DreamTalk** | 📸 照片+音频 | 扩散 | — | 2024 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐ | 1789 |
| 15 | **Hallo** (v1) | 📸 照片+音频 | 分层扩散 | — | 2024.06 | ✅ A100 | ✅英文 | ❓ | A100 | ⭐⭐⭐ | 8658 |
| 16 | **Hallo-Live** | 📸 照片+音频 | 扩散实时 | — | — | ✅ | ✅ | ✅ MIT | 未标注 | ⭐⭐⭐ | — |
| 17 | **VividTalk** | 📸 照片+音频 | 3D 混合先验 | — | 2024 | ✅ | ✅ | ✅ Apache | 未标注 | ⭐⭐⭐⭐ | 801 |
| 18 | **GaussianTalker** | 📸 照片+音频 | 3D GS | — | 2024 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐⭐ | 411 |
| 19 | **DiffTalk** | 📸 照片+音频 | 扩散 | **CVPR 2023** | 2023 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐⭐ | 472 |
| 20 | **DAWN** | 📸 照片+音频 | 非自回归扩散 | — | 2024 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐ | 233 |
| 21 | **LinguaLinker** | 📸 照片+音频 | 隐式面部控制 | — | 2024 | ✅ | ✅ | ✅ Apache | 未标注 | ⭐⭐⭐ | 73 |
| 22 | **FantasyTalking2** | 📸 照片+音频 | 扩散 | **AAAI 2026** | 2025 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐⭐ | 65 |

#### T2 — 3DMM / GAN 方案（2020-2023，技术较旧但可参考）

| 排名 | 模型 | 输入类型 | 技术路线 | 会议 | 时间 | NVIDIA 必需 | 音频驱动 | 商用 | VRAM | 质量 | GitHub Stars |
|------|------|---------|---------|------|------|-----------|---------|------|------|------|-------------|
| 17 | **SadTalker** | 📸 照片+音频 | 3DMM | — | 2022.11 | ✅（MPS ⚠️） | ✅ | ❌ 非商用 | ~6GB | ⭐⭐⭐ | — |
| 18 | **StyleSync** | 📸 照片+音频 | 扩散+风格 | **CVPR 2023** | 2023 | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐ | 328 |
| 19 | **Real3D-Portrait** | 📸 照片+音频 | 3D 肖像 | — | — | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐ | — |
| 20 | **GeneFace++** | 📸 照片+音频 | 3DMM+NeRF | — | — | ✅ | ✅ | ❓ | 未标注 | ⭐⭐⭐ | — |
| 21 | **LivePortrait** | 🎥 视频+视频 | 视频驱动 | — | 2024 | ✅（MPS ⚠️） | ❌ 视频 | ❌ | ~8GB | ⭐⭐⭐⭐ | — |
| 22 | **Wav2Lip** | 📸 照片+音频 | GAN | **ACM MM 2020** | 2020 | ⚠️ CPU 可 | ✅ | ❌ 非商用 | ~4GB | ⭐⭐ | — |
| 23 | **VideoReTalking** | 🎥 视频+音频 | 扩散唇同步 | **SIGGRAPH Asia 2022** | 2022 | ✅ | ✅ | ❓ | ~8GB | ⭐⭐⭐ | 7276 |
| 24 | **AD-NeRF** | 📸 照片+音频 | NeRF | — | 2021 | ✅ | ✅ | ✅ MIT | ~8GB | ⭐⭐ | 1074 |
| 25 | **DaGAN** | 🎥 视频+视频 | GAN | **CVPR 2022** | 2022 | ✅ | ✅ | ❓ | ~6GB | ⭐⭐ | 996 |
| 26 | **Audio2Head** | 📸 照片+音频 | NeRF | — | 2022 | ✅ | ✅ | ❓ | ~8GB | ⭐⭐ | 353 |
| 27 | **Text2Video** | 📝 文本→视频 | 文本驱动 | **ICASSP 2022** | 2022 | ✅ | ✅ 文本 | ❓ | ~6GB | ⭐⭐ | 438 |
| 28 | **MCNET** | 📸 照片+音频 | 隐式身份 | **ICCV 2023** | 2023 | ✅ | ✅ | ❓ | ~6GB | ⭐⭐ | 252 |
| 29 | **MultiTalk** | 📸 照片+音频 | 3D | **INTERSPEECH 2024** | 2024 | ✅ | ✅ | ❓ | ~8GB | ⭐⭐ | 196 |
| 30 | **EAT** | 📸 照片+音频 | 情感适配 | **ICCV 2023** | 2023 | ✅ | ✅+情感 | ❓ | ~6GB | ⭐⭐ | 300 |
| 31 | ~~MuseTalk~~ | 📸 照片+音频 | VAE 替换 | — | 2024 | MLX ✅ | ✅ | ✅ MIT | 7GB | ❌ 模糊 | — |

#### T3 — 闭源 / 商用 API

| 排名 | 平台 | 输入类型 | 技术 | 音频驱动 | 商用 | 价格 |
|------|------|---------|------|---------|------|------|
| 1 | **HeyGen** | 📸 照片 / 🎓 视频克隆 | 专有（非公开） | ✅ TTS+音频 | ✅ | Free $0(3视频)；Creator $29/月(600 credits)；Pro $49/月(1000 credits) |
| 2 | **D-ID** | 📸 照片 / 🎓 视频克隆 | 专有 | ✅ TTS+音频 | ✅ | Trial $0(3min)；Lite $4.7/月(10min)；Pro $16/月(15min)；Advanced $108/月(100min) |
| 3 | **Synthesia** | 🎓 预置/Custom | 专有 | ✅ TTS | ✅ | $29+/月 |
| 4 | **Sync.so** | 🎥 视频+音频 | 专有(Wav2Lip 商用) | ✅ 音频 | ✅ | 按量付费 |
| 5 | **DUIX/Duix-Avatar** | 🎓 视频克隆 | 开源工具包 | ✅ 音频 | ✅ | 免费（开源） |
| 6 | **OpenTalking** | 📸+🎓 混合 | 工业级框架 | ✅ | ✅ | 免费（Apache 2.0） |
| 7 | **HeyGem** | 🎥 视频+音频 | ONNX 唇同步 | ✅ 音频 | Other | 免费（开源） |
| 8 | **Linly-Talker** | 📸 照片+音频 | LLM+SadTalker | ✅ | — | 免费（开源） |
