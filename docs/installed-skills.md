...
|-------|----------------|---------|---------|
| `deep-research` | `199-biotechnologies/claude-deep-research-skill` | Methodology backend (8-phase pipeline, Python scripts, evidence persistence). `disable-model-invocation: true` — only loaded by `web-deep-research`, not auto-triggered. | Manual clone to `.agents/skills/` |
