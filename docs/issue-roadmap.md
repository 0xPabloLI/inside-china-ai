...
>
> **frontier**：Tier 1 可立即开工 **#298**（P1）；#300/#302 并行调研（W3A）；#326/#346/#347 等 `needs-triage` 先分流再开工。
>
...
| **W3B** | 媒体底座与素材体系 | `asset-sourcer.mjs` `knowledge/media-catalog.json` | #310（🎯）#293 #314｜D：#288 #301 | #310 吸收 #288/#301；#297 fail-closed 已闭票；#309 定链审计结论已备 |
