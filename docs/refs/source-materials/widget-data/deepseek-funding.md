# Widget Data: deepseek-funding

> Exported from `src/components/widgets/deepseek/data/funding.ts`
> Widget type: 融资时间线（funding timeline）— DeepSeek 融资轮次 + 投资方分布
> Last updated: 2026-07-28 (git: 2026-07-28 18:53:54 +0800)
> View component: `src/components/widgets/deepseek/funding-view.tsx` → `FundingView`
> Registered as breakout widget (wider than 65ch article column)
...
- https://en.wikipedia.org/wiki/DeepSeek — DeepSeek 词条
- https://elsewhere.news/en/elsewhere/deepseek — elsewhere 别处发生 (多处引用)
- https://elsewhere.news/en/elsewhere/wenfeng-liangs-four-hour-investor-meeting-full-transcript — 四小时投资者交流会全文
- https://en.cryptonomist.ch/2026/07/14/deepseek-new-funding/ — Cryptonomist (2026-07-14)
- https://fortune.com/2026/07/25/deepseek-liang-wenfeng-backers-fundraising-pause-viral-posts-investors/ — Fortune/Bloomberg (2026-07-25, Haze Fan & Pei Li)
- The Information (2026-04-17, ~$10B target valuation report)
- The Silicon Review (2026-05-07, $45B valuation jump report)
- TechStartups (2026-06-17, $7.4B/$50B first round report)

## Related Articles

- Not embedded in any published article via `<!-- widget:deepseek-funding -->`.
- Content relates to `deepseek-art-of-restraint` (DeepSeek 融资文章).
