# Source: 豆包工作正式发布 (WeChat Article)

**Source URL**: https://mp.weixin.qq.com/s/YG4UPmy3M-zaJZjFrTSo0w
**OG Title**: 豆包工作，正式发布！
**Date**: 2026-08-25
**Author/Account**: 豆包工作 (WeChat Official Account)
**Business ID**: MzY4NzQxMTg2Mg==
**Message ID**: 2247485472

## Video Card Description (from WeChat HTML)

> 豆包工作，正式发布！豆包工作是一款面向生产力场景的全新 Agent 产品，不只「生成内容」，更帮助个人与企业「完成工作」，豆包工作还与飞书深度打通，让Agent基于企业上下文更准确地完成工作！即刻体验，派出你的第一个豆包工作任务。#豆包工作

## Live Stream Notice

> 将在08月25日 19:00 直播 — 豆包工作新品见面会

## Content Summary (from images + pedaily.cn report)
...
4. **Skills, connectors, work partners**: Extensible AI ecosystem. Multiple professional agents can form a "work squad" for collaborative complex tasks.
5. **Deep Feishu integration**: Users logging in with Feishu account inherit enterprise knowledge and work context. Can access chat records, documents, meeting notes, schedules within authorization scope.
6. **Knowledge accumulation**: Content created with Doubao Work flows back to Feishu as reusable enterprise knowledge.
...
- Feishu GTM team merged with Volcano Engine
...
- Competitors: Tencent WorkBuddy (20.97M monthly visits, #1 in agent office), Alibaba Qianwen Office
