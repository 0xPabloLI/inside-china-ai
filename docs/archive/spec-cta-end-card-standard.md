...
| scripts/short-video/**tests**/scene-rules.test.mjs                  | validScenes cta 补 `action` + 新检查测试           | Low      | fixture 更新 + 追加                                                                                                                       |
| scripts/short-video/**tests**/scene-templates.test.mjs              | ctaScene 测试块                                    | Low      | 追加                                                                                                                                      |
| scripts/short-video/**tests**/scene-drift.test.mjs                  | CTA 等值漂移守卫 + evergreen 契约断言              | Low      | 追加                                                                                                                                      |
| scripts/short-video/**tests**/distillation-pt1-scenes.test.mjs      | scene8 断言更新                                    | Low      | 随数据契约更新                                                                                                                            |
