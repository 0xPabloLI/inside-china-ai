...
> Prerequisite doc: `docs/rag-prework.md` (D1-D5 decisions confirmed)
...
| `docs/rag-prework.md` | Update D3 (remove widget-data), add Q11-Q19 decisions | **Low** | Documentation update only |
...
11. **`docs/rag-prework.md`** — Update with Q1-Q19 decisions, revise D3
