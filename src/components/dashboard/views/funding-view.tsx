  ...
  return (
    <div className="space-y-5">
            ...
            {INVESTOR_DATA.map((inv) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span className="flex-1 text-[11px] font-semibold text-foreground/80">{name}</span>
                  <span className="text-[11px] font-bold text-foreground whitespace-nowrap">{amtStr}</span>
                </div>
              );
            })}
      ...
      <div>
        ...
        <div className="flex items-end gap-2.5 border-b border-border/40 pb-1" style={{ height: 200 }}>
        ...
        {selected && (
          <div className="mt-3 rounded-lg border border-border/60 bg-muted/30 px-3.5 py-2.5 text-[11px] leading-relaxed text-muted-foreground">
            <div className="flex items-center gap-2 mb-1">
              <strong className="text-foreground">{selected.date} · {isZh ? selected.eventZh : selected.eventEn}</strong>
              <span
