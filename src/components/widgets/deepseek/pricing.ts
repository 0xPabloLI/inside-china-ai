...
export const PRICING_DATA: PricingVendor[] = [
  ...
  },
  {
    ...
    models: [
      {
        nameZh: "MiMo-V2.5-Pro",
        nameEn: "MiMo-V2.5-Pro",
        input: 3,
        output: 6,
        context: "1M",
        tierZh: "旗舰",
  ...
  },
  {
    ...
    models: [
      ...
      {
        nameZh: "Qwen3.6-Max-Preview",
        nameEn: "Qwen3.6-Max-Preview",
        input: 9,
        output: 54,
        context: "256K",
        tierZh: "专业",
  ...
  {
    vendorZh: "腾讯混元",
    vendorEn: "Tencent Hunyuan",
    color: "#6DC8EC",
    region: "cn",
    models: [
      {
        nameZh: "Hunyuan-role-latest",
        nameEn: "Hunyuan-role-latest",
        input: 2.4,
        output: 9.6,
        context: "256K",
        tierZh: "旗舰",
  ...
  {
    vendorZh: "字节豆包",
    vendorEn: "ByteDance Doubao",
    color: "#945FB9",
    region: "cn",
    models: [
      {
        nameZh: "Seed-Evolving",
        nameEn: "Seed-Evolving",
        input: 6,
        output: 30,
        context: "256K",
        tierZh: "旗舰",
      ...
      {
        nameZh: "Seed-2.1-Turbo",
        nameEn: "Seed-2.1-Turbo",
        input: 3,
        output: 15,
        context: "128K",
        tierZh: "专业",
  ...
  // ── Overseas (USD) ──
  {
    ...
    models: [
      ...
      {
        nameZh: "GPT-5.6-Terra",
        nameEn: "GPT-5.6-Terra",
        input: 2.5,
        output: 15,
        context: "1M",
        tierZh: "专业",
  ...
  },
  {
    ...
    models: [
      ...
      {
        nameZh: "Claude Opus 5",
        nameEn: "Claude Opus 5",
        input: 5,
        output: 25,
        context: "1M",
        tierZh: "专业",
  ...
  {
    vendorZh: "Google",
    vendorEn: "Google Gemini",
    color: "#4285F4",
    region: "overseas",
    models: [
      {
        nameZh: "Gemini 3.1 Pro Preview",
