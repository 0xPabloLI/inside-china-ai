...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.png", type: "image/png", sizes: "76x64" },
      {
        rel: "alternate",
        type: "application/rss+xml",
        title: "China AI News — RSS",
        href: "/rss.xml",
      },
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Hanken+Grotesk:wght@400;500;600;700&family=Source+Serif+4:ital,wght@0,400;0,600;0,700;1,400&display=swap",
      },
    ],
  }),
