...
const TIKTOK_CLIENT_KEY = "awaaaaaaXXXXXXXXXXXXXXXX"; // placeholder — replace with real client_key from developer portal
const REDIRECT_URI = "https://chinaai.lovable.app/api/tiktok/callback";
