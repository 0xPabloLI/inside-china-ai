...
export function generateBGM(duration = 180) {
  ...
  const args = [
    ...
    "lavfi",
    "-i",
    `sine=frequency=55:duration=${duration}`,
    "-f",
    "lavfi",
    "-i",
    `sine=frequency=110:duration=${duration}`,
    "-f",
    "lavfi",
    "-i",
    ...
    "lavfi",
    "-i",
    `sine=frequency=277:duration=${duration}`,
    "-f",
    "lavfi",
    "-i",
    `sine=frequency=330:duration=${duration}`,
    "-f",
    "lavfi",
    "-i",
    ...
    "lavfi",
    "-i",
    `anoisesrc=color=pink:duration=${duration}:amplitude=0.02`,
    "-filter_complex",
    filterComplex,
    "-map",
    "[out]",
