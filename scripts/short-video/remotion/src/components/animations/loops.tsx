...
export const ScanSweep: React.FC<{ duration: number; color?: string; style?: React.CSSProperties }> = ({
  duration,
...
export const GlitchFlash: React.FC<{ delay?: number; children?: ReactNode; style?: React.CSSProperties }> = ({
  delay = 0,
  style,
}) => {
  const frame = useCurrentFrame();
