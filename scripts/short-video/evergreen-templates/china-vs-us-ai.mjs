...
export const scenes = [
  ...
  },
  {
    ...
    name: "chips",
    visualType: "contrast",
    voiceover: "The US restricts chip exports. China builds its own. Huawei's Ascend chip is closing the gap.",
  ...
  },
  {
    ...
    voiceover: "US models cost more. Chinese models cost less. Same performance, different price tag.",
  ...
  },
  {
    ...
    texts: { title: "OPEN vs CLOSED", points: ["DeepSeek: MIT license", "OpenAI: proprietary", "China leads open-source AI"] },
  },
  {
    id: 5,
    name: "cta",
...
export const metadata = {
  ...
  description: "China builds cheaper, open-source AI. The US restricts chips.\nBut China's chip industry is catching up.\nFollow for more China AI news.",
