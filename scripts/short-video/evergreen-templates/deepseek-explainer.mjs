...
export const scenes = [
  ...
  },
  {
    ...
    name: "origin",
    visualType: "timeline",
    voiceover: "DeepSeek was founded by Liang Wenfeng in 2023. Backed by High-Flyer, a quantitative hedge fund.",
    texts: { events: [{ date: "2023", text: "FOUNDED" }, { date: "2024", text: "V3 LAUNCH" }, { date: "2025", text: "R1 BREAKTHROUGH" }] },
  },
  {
    id: 3,
    name: "pricing",
    visualType: "price-comparison",
    voiceover: "DeepSeek's API costs one-twentieth the price of Claude or GPT. Fourteen cents per million tokens.",
  ...
  },
  {
    ...
    voiceover: "DeepSeek open-sources its strongest models. Same weights as production. Not a watered-down version.",
    texts: { title: "OPEN-SOURCE FIRST", points: ["Production weights", "MIT license", "Actively helps competitors"] },
  },
  {
    id: 5,
    name: "cta",
