...
export const scenes = [
  ...
  },
  {
    ...
    name: "qwen",
    visualType: "open-source",
    voiceover: "Alibaba's Qwen models are top of open-source leaderboards. Multiple sizes, multiple languages.",
    texts: { title: "QWEN (ALIBABA)", points: ["Top open-source model", "Multilingual", "Multiple sizes"] },
  },
  {
    id: 4,
    name: "kimi",
    ...
    texts: { title: "KIMI (MOONSHOT)", points: ["2M token context", "Longest context window", "Chinese company"] },
  },
  {
    id: 5,
    name: "cta",
...
export const metadata = {
  ...
  description: "DeepSeek, Qwen, Kimi — China's open-source AI models are dominating.\nProduction weights, MIT license, 1/20 the cost.\nFollow for more China AI news.",
