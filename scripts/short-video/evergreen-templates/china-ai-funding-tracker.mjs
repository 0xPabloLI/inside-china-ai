...
export const scenes = [
  ...
  },
  {
    ...
    name: "deepseek",
    visualType: "data",
    voiceover: "DeepSeek raised $1.4 billion. Then the meeting leaked. The round paused. But the valuation is already $5 billion.",
  ...
  },
  {
    ...
    name: "moonshot",
    visualType: "data",
    voiceover: "Moonshot AI (Kimi) raised $3.5 billion. Founded by Yang Zhilin. Backed by Alibaba and Tencent.",
  ...
  },
  {
    ...
    name: "zhipu",
    visualType: "data",
    voiceover: "Zhipu AI raised $400 million. Founded by Tsinghua University researchers. Backed by Saudi Arabia's Prosperity7 Ventures.",
