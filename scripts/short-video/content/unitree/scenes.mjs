...
.s2 .narrative-badge { display: inline-block; padding: 10px 24px; border: 2px solid rgba(245,158,11,0.4); border-radius: 8px; background: rgba(245,158,11,0.08); font-size: 22px; font-weight: 800; color: var(--amber); letter-spacing: 2px; margin-bottom: 24px; animation: stampIn 0.4s ease-out 0.2s forwards; opacity: 0; }
.s2 .company-name { font-size: 48px; font-weight: 900; color: var(--white); margin-bottom: 16px; animation: slideUp 0.5s ease-out 0.4s forwards; opacity: 0; }
.s2 .action-text { font-size: 32px; font-weight: 700; color: var(--sec); margin-bottom: 12px; animation: slideUp 0.5s ease-out 0.6s forwards; opacity: 0; }
.s2 .result-text { font-size: 56px; font-weight: 900; color: var(--amber); animation: stampIn 0.5s ease-out 0.8s forwards; opacity: 0; }
.s2 .context-text { font-size: 24px; font-weight: 600; color: var(--sec); margin-top: 16px; animation: fadeIn 0.5s ease-out 1.0s forwards; opacity: 0; }
</style></head><body>
<div class="scene s2">
${media.html}
...
.s3 .big-stat { font-size: 180px; font-weight: 900; color: var(--amber); line-height: 0.9; animation: stampIn 0.5s ease-out 0.2s forwards; opacity: 0; }
.s3 .stat-label { font-size: 36px; font-weight: 800; color: var(--white); letter-spacing: 4px; margin-top: 16px; animation: slideUp 0.5s ease-out 0.5s forwards; opacity: 0; }
.s3 .subtext { font-size: 28px; font-weight: 600; color: var(--sec); margin-top: 24px; animation: fadeIn 0.5s ease-out 0.8s forwards; opacity: 0; }
.s3 .source { font-size: 20px; font-weight: 600; color: var(--muted); margin-top: 20px; letter-spacing: 1px; animation: fadeIn 0.5s ease-out 1.0s forwards; opacity: 0; }
</style></head><body>
...
.s4 .card-title { font-size: 28px; font-weight: 900; color: var(--blue); margin-bottom: 8px; }
.s4 .card-highlight { color: var(--amber); }
.s4 .card-subtitle { font-size: 22px; font-weight: 600; color: var(--sec); margin-bottom: 20px; }
.s4 .card-points { list-style: none; padding: 0; }
.s4 .card-points li { font-size: 26px; font-weight: 700; color: var(--white); margin-bottom: 12px; padding-left: 28px; position: relative; animation: slideUp 0.4s ease-out forwards; opacity: 0; }
...
function scene5(scene, duration) {
  ...
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>
${baseStyles(duration)}${templateCss()}${slotCss()}${media.css}
.s5 .narrative-badge { display: inline-block; padding: 10px 24px; border: 2px solid rgba(239,68,68,0.4); border-radius: 8px; background: rgba(239,68,68,0.08); font-size: 22px; font-weight: 800; color: var(--red); letter-spacing: 2px; margin-bottom: 24px; animation: stampIn 0.4s ease-out 0.2s forwards; opacity: 0; }
.s5 .company-name { font-size: 48px; font-weight: 900; color: var(--white); margin-bottom: 16px; animation: slideUp 0.5s ease-out 0.4s forwards; opacity: 0; }
.s5 .action-text { font-size: 32px; font-weight: 700; color: var(--sec); margin-bottom: 12px; animation: slideUp 0.5s ease-out 0.6s forwards; opacity: 0; }
.s5 .result-text { font-size: 42px; font-weight: 900; color: var(--red); animation: stampIn 0.5s ease-out 0.8s forwards; opacity: 0; }
.s5 .context-text { font-size: 24px; font-weight: 600; color: var(--amber); margin-top: 16px; animation: fadeIn 0.5s ease-out 1.0s forwards; opacity: 0; }
</style></head><body>
<div class="scene s5">
${media.html}
...
.s6 .quote-mark { font-size: 160px; font-weight: 900; color: rgba(239,68,68,0.15); line-height: 0.8; margin-bottom: -30px; animation: fadeIn 0.5s ease-out 0.2s forwards; opacity: 0; }
.s6 .quote { font-size: 42px; font-weight: 700; color: var(--white); text-align: center; line-height: 1.35; max-width: 820px; animation: slideUp 0.6s ease-out 0.5s forwards; opacity: 0; }
.s6 .source { margin-top: 36px; font-size: 24px; font-weight: 700; color: var(--sec); letter-spacing: 2px; text-align: center; animation: fadeIn 0.5s ease-out 1.3s forwards; opacity: 0; }
...
.s6 .verified .text { font-size: 24px; font-weight: 800; color: var(--amber); letter-spacing: 2px; }
...
.s7 .card-badge { display: inline-block; padding: 8px 20px; border: 1px solid rgba(77,139,255,0.3); border-radius: 6px; font-size: 18px; font-weight: 800; color: var(--blue); letter-spacing: 2px; margin-bottom: 20px; animation: stampIn 0.4s ease-out 0.2s forwards; opacity: 0; }
.s7 .card-title { font-size: 36px; font-weight: 900; color: var(--white); margin-bottom: 8px; animation: slideUp 0.5s ease-out 0.4s forwards; opacity: 0; }
.s7 .card-highlight { color: var(--blue); }
.s7 .context-detail { font-size: 28px; font-weight: 700; color: var(--amber); margin-top: 16px; animation: slideUp 0.5s ease-out 0.6s forwards; opacity: 0; }
.s7 .extra-detail { font-size: 22px; font-weight: 600; color: var(--sec); margin-top: 12px; animation: fadeIn 0.5s ease-out 0.8s forwards; opacity: 0; }
</style></head><body>
...
.s8 .vs-title { font-size: 36px; font-weight: 900; color: var(--white); text-align: center; margin-bottom: 24px; animation: slideUp 0.5s ease-out 0.2s forwards; opacity: 0; }
.s8 .vs-badge { display: inline-block; padding: 6px 20px; border: 1px solid var(--muted); border-radius: 6px; font-size: 22px; font-weight: 900; color: var(--muted); letter-spacing: 2px; margin: 0 auto 20px; animation: stampIn 0.4s ease-out 0.4s forwards; opacity: 0; }
...
.s8 .chip { display: inline-block; padding: 8px 16px; border-radius: 6px; font-size: 22px; font-weight: 700; animation: slideUp 0.4s ease-out forwards; opacity: 0; }
...
.s8 .note { text-align: center; font-size: 22px; font-weight: 700; color: var(--sec); margin-top: 16px; animation: fadeIn 0.5s ease-out 1.2s forwards; opacity: 0; }
...
.s9 .big-stat { font-size: 220px; font-weight: 900; color: var(--amber); line-height: 0.9; animation: stampIn 0.6s ease-out 0.2s forwards; opacity: 0; }
.s9 .stat-label { font-size: 36px; font-weight: 800; color: var(--white); letter-spacing: 4px; margin-top: 16px; animation: slideUp 0.5s ease-out 0.6s forwards; opacity: 0; }
.s9 .subtext { font-size: 26px; font-weight: 600; color: var(--sec); margin-top: 24px; animation: fadeIn 0.5s ease-out 0.9s forwards; opacity: 0; }
.s9 .source { font-size: 20px; font-weight: 600; color: var(--muted); margin-top: 16px; letter-spacing: 1px; animation: fadeIn 0.5s ease-out 1.1s forwards; opacity: 0; }
</style></head><body>
