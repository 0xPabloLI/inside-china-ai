...
/* ── S1: Hook — "I'm Claude" (three-layer open, first-frame striking) ── */
...
.s1 .big-text { text-align: center; font-size: 130px; font-weight: 900; color: var(--red); letter-spacing: 2px; line-height: 1; text-shadow: 0 0 60px rgba(239,68,68,0.5), 0 0 120px rgba(239,68,68,0.3); animation: stampIn 0.5s cubic-bezier(0.16,1,0.3,1) 0.3s forwards, glitchShift 3s ease-in-out 1s infinite; opacity: 0; }
...
.s1 .second-stat { text-align: center; font-size: 64px; font-weight: 900; color: var(--amber); letter-spacing: 1px; line-height: 1; text-shadow: 0 0 50px rgba(245,158,11,0.4); animation: stampIn 0.5s cubic-bezier(0.16,1,0.3,1) 1.2s forwards; opacity: 0; }
