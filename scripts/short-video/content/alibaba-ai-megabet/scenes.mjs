/**
 * Alibaba 80B HKD AI investment video — scenes.mjs
 *
 * Scenes 2-8 use "narrative" visualType with media backgrounds.
 * Scene 1 (hook) uses shared hookScene template.
 * Scene 9 (cta) uses shared ctaScene template.
 */
...
// ─── S2-S8: Narrative — media background + content card ───
