 ...
 * (decision 59, spec-text-overflow-hardening.md): 15/15 content packs were on
...
export function assertRemotionRenderer({ argv = [], meta = {} } = {}) {
  ...
  throw new Error(
    `The HTML/Playwright render path was retired on 2026-09-01 (decision 59, ` +
      `spec-text-overflow-hardening.md) — Remotion is the only renderer, but this run requested ` +
