...
export const tiktokProfile = {
  ...
  // ─── Manual guide step sequence (mirrors publish-utils.mjs buildManualPublishGuide) ───

  manualGuide: {
    steps: [
      { id: "open-app", label: "Open TikTok app → Tap [+] to upload" },
      { id: "select-video", label: "Select the video file" },
      { id: "aigc-label", label: 'Toggle "AI-generated content" ON (CRITICAL)' },
      { id: "paste-caption", label: "Paste caption into the description field" },
      { id: "edit-sticker", label: "Edit → add a text sticker or effect (algorithm bonus)" },
      { id: "add-sound", label: "Add sound → pick a trending sound (volume 5-10%)" },
      { id: "location", label: 'Location → select "China" or "United States"' },
      { id: "privacy", label: 'Set privacy to "Public" (or "Friends" for testing)' },
      { id: "publish", label: "Publish" },
      { id: "first-hour-engagement", label: "First hour: reply to EVERY comment" },
      { id: "pin-comment", label: "Pin a comment with the article link" },
    ],
  },
