---
title: "Alibaba's $10B AI Megabet: 80 Billion HKD Mega-Offering"
slug: "alibaba-80b-ai-megabet"
excerpt: "Alibaba raises 80 billion HKD in its first share placement since 2019, with 100% earmarked for full-stack AI infrastructure. Jack Ma and top executives bought shares simultaneously, signaling confidence in the company's AI-first pivot."
published: true
---
...
- **AI Cloud & Computing Services adjusted EBITA**: up 133% year-over-year, with margin improving to 12%
- **Capital expenditure**: 67.678 billion RMB, up 75% year-over-year
- **Free cash flow**: negative 44.67 billion RMB, expanded from negative 18.815 billion RMB a year earlier

The negative free cash flow tells the story: Alibaba is in an aggressive "investment-for-market-share" phase, pouring capital into AI infrastructure at a rate that outpaces even its massive operating cash generation.
...
This offering is not happening in isolation. It reflects a broader pattern of Chinese tech giants doubling down on AI infrastructure spending:

- **ByteDance** is estimated to spend $28 billion annually on AI infrastructure, with its AI business ARR reaching $4 billion as of July 2026
- **Tencent** continues investing in AI capabilities across its product ecosystem, recently launching WorkBuddy for the enterprise market
- Alibaba's $10 billion raise, combined with its existing capital expenditure trajectory, positions it as the most aggressively capitalized AI player in China

The race is not just about who has the best models. It is about who controls the full stack: chips, compute, models, and applications. Alibaba's 80 billion HKD bet signals that the company believes owning all four layers is the only path to winning the China AI race.

The question now is whether 3-year payback projections hold, or whether the massive capital deployment will follow the pattern of previous tech investment cycles, where the winners were determined not by who spent the most, but by who spent most effectively.
