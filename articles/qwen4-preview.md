...
At 0.8 yuan per million input tokens, that means million-token context at commodity prices, on open weights, for agent workloads that read entire codebases or day-long meeting transcripts.
